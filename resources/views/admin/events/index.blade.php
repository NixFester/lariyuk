  ...
  <div class="overflow-x-auto">
    <table class="w-full text-sm">
      <thead><tr class="bg-gray-50 text-left">
        ...
        <th class="px-5 py-3 text-xs font-semibold text-slate-500 uppercase">Edit</th>
        <th class="px-5 py-3 text-xs font-semibold text-slate-500 uppercase">Rekapan</th>
      </tr></thead>
      <tbody class="divide-y divide-gray-100">
        ...
        <tr class="hover:bg-gray-50">
          ...
          <td class="px-5 py-4">
            <a href="{{ route('admin.registrations.export-excel', $event->id) }}" class="px-3 py-1.5 bg-gray-50 hover:bg-gray-100 text-gray-700 text-xs font-medium rounded-lg transition-colors">Lihat Rekapan</a>
          </td>
        </tr>
        @endforeach
      </tbody>
